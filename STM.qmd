...
out <- prepDocuments(myprocess$documents, myprocess$vocab, myprocess$meta,lower.thresh = 50,verbose = F)
```
...
# 고해상도 PNG로 저장
ggsave("AI_Skills_Importance_High_Res.png", plot = p, width = 10, height = 6, dpi = 300)
```
...
write.xlsx(skill_summary,'skill_summary.xlsx')
```
